...
emit_rauc() {
	...
	[handlers]
	# RAUC ships no official Raspberry Pi firmware backend; this is the Rtone one.
	# ⚠️ unverified against current upstream — see ROADMAP 4d.
	bootloader-custom-backend=/usr/lib/rauc/rpi-firmware-backend
